"""
Django settings for Michael_Lee_Digital_Website project.
...
ROOT_URLCONF = 'Michael_Lee_Digital_Website.urls'
...
WSGI_APPLICATION = 'Michael_Lee_Digital_Website.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'info/static/')